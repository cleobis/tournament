...
function siteorigin_metaslider_layout_big_headline($layouts){
	$layouts['big-headline'] = array(
		'title' => __('Big Headline', 'vantage'),
		'html' =>
			siteorigin_metaslider_layer(
				'<h2><span style="font-size: 2.75em; color: #FFFFFF; text-align: center">'.__('This Is The First Line', 'vantage').'<br/><span style="font-weight:300">'.__('This is The Second', 'vantage').'</span></span></h2>',
