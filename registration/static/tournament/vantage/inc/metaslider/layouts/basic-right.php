<?php
if( !function_exists('siteorigin_metaslider_layout_basic_right') ) :
function siteorigin_metaslider_layout_basic_right($layouts){
	$layouts['basic-right'] = array(
		'title' => __('Basic Right', 'vantage'),
		'html' =>
			siteorigin_metaslider_layer(
				'<h2><span style="font-size: 2.75em; color: #FFFFFF">'.__('This Is The First Line', 'vantage').'<br/><span style="font-weight:300">'.__('This is The Second', 'vantage').'</span></span></h2>',
				array(),
			...
			siteorigin_metaslider_layer(
				'<p class="siteorigin-slider-action-button"><a href="#"><span>'.__('An Action Button', 'vantage').'</span></a></p>',
				array(),
